	...
	*/
	...
	void LoadMeshes()
	{
		...
		std::vector<Vertex> data = {
			{-0.5f, 0.5f, 0.5f, 1.0f, 0.5f, 0.1f, 0.2f},
			{0.5f, -0.5f, 0.5f, 0.0f, 0.5f, 0.5f, 0.0f},
			{-0.5f, -0.5f, 0.5f, 0.5f, 0.5f, 0.0f, 0.5f},
			{0.5f, 0.5f, 0.5f, 0.0f, 0.8f, 0.0f, 0.0f}
		...
		data = {
			{-0.75f, 0.5f, 0.70f, 1.0f, 0.5f, 0.1f, 0.2f},
			{0.75f, -0.5f, 0.70f, 1.0f, 0.5f, 0.1f, 0.0f},
			{-0.75f, -0.5f, 0.70f, 1.0f, 0.5f, 0.1f, 0.5f},
			{0.75f, 0.5f, 0.70f, 1.0f, 0.5f, 0.1f, 0.0f}

		};

		mesh02.LoadMesh(*m_pDevice, *m_pCommandList, &data, &indices);
