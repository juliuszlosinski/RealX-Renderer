...
class D3D12AppXeSS
{
    ...
    FPSCounter                              m_FPSCounter{"d3d12_app_XeSS_fps_counter.log"};
    ...
    void FillCommandList()
    {
        ...
        CD3DX12_CPU_DESCRIPTOR_HANDLE rtvHandle =
            CD3DX12_CPU_DESCRIPTOR_HANDLE(
                ...
                (INT)(m_FrameIndex * RT_COUNT + RT_Color), m_RenderTargetViewDescriptorSize
            );       // np.: 0 * 3 + 1 (Nice!)
        ...
        rtvHandle =
            CD3DX12_CPU_DESCRIPTOR_HANDLE(m_RenderTargetsViewsDescriptorHeap->GetCPUDescriptorHandleForHeapStart(),
                (INT)(m_FrameIndex * RT_COUNT + RT_Velocity), m_RenderTargetViewDescriptorSize
            );
        ...
        rtvHandle =
            CD3DX12_CPU_DESCRIPTOR_HANDLE(m_RenderTargetsViewsDescriptorHeap->GetCPUDescriptorHandleForHeapStart(),
                (INT)(m_FrameIndex * RT_COUNT), m_RenderTargetViewDescriptorSize);
        m_GraphicsCommandList->OMSetRenderTargets(1, &rtvHandle, FALSE, nullptr);
